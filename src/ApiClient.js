...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://services.dev.docusign.net/aow-manage/v1.0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://services.dev.docusign.net/aow-manage/v1.0
         */
