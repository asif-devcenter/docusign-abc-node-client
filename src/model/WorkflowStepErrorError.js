...
class WorkflowStepErrorError {
    ...
    constructor() { 
        ...
        WorkflowStepErrorError.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkflowStepErrorError();
    ...
    /**
     * Validates the JSON data with respect to <code>WorkflowStepErrorError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorkflowStepErrorError</code>.
     */
 ...
 * @member {String} code
 */
WorkflowStepErrorError.prototype['code'] = undefined;

/**
 * Error Message which shares more details
 * @member {String} message
 */
WorkflowStepErrorError.prototype['message'] = undefined;
...
export default WorkflowStepErrorError;
